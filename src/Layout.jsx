...
import { Home, List, Users, Settings as SettingsIcon, MapPin, Zap, BarChart3, Calendar as CalendarIcon } from "lucide-react";
...
const TAB_PAGES = ["Dashboard", "Leads", "CalendarView", "Analytics", "MapView", "Buyers", "Campaigns"];
...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
    ...
    { name: "Calendar", icon: CalendarIcon, page: "CalendarView" },
