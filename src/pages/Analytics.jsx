...
export default function Analytics() {
  ...
  const totalRevenue = offers?.filter(o => o.outcome === "Accepted").reduce((sum, o) => sum + (o.assignment_fee_target || 0), 0) || 0;
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <Tabs defaultValue="performance" className="space-y-4">
          ...
          <TabsContent value="performance">
            <PerformanceMetrics leads={leads} messages={messages} offers={offers} />
          </TabsContent>
          ...
          <TabsContent value="response">
            <ResponseTimeChart leads={leads} messages={messages} />
          </TabsContent>

          <TabsContent value="revenue">
            <RevenueProjections leads={leads} offers={offers} contracts={contracts} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
